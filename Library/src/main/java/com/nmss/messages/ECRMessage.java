 ...
 */
public class ECRMessage extends Message {

	public ECRMessage(String ORIGIN_HOST, String ORIGIN_REALM, String DESTINATION_HOST, String DESTINATION_REALM,
	...
	private ECRMessage(String ORIGIN_HOST, String ORIGIN_REALM, String DESTINATION_HOST, String DESTINATION_REALM,
                       int vendor_id, int AUTH_APP, String IMPI, String tid, boolean isProxy) {
		super.hdr.setRequest(true);
		super.hdr.command_code = ProtocolConstants.DIAMETER_ME_IDENTITY_CHECK_REQUEST;
