...
/**
 * 32-bit unsigned integer AVP. RFC3855 describes the Unsigned32 AVP type. Java
 * does not have an appropriate unsigned data type, so this class is
 * functionally equivalent to {@link AVP_Integer32}
 */
